 ...
 */
final class Version20220903090532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE complect RENAME COLUMN deleted_at TO deletedAt');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE complect RENAME COLUMN deletedAt TO deleted_at');
    }
}
